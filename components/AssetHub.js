...
const DESCRIPTIONS = {
  ...
  SATA: (
    <div className="space-y-3">
      <p>SATA is Strive&apos;s perpetual preferred equity instrument, listed on the Nasdaq. It pays a 13.00% annual dividend distributed as a daily cash payment on every NYSE business day — approximately 21 payments per month. Strive believes SATA is the first listed security in history to pay daily dividends. Strive targets a $99–$101 trading range to minimise price volatility and provide a predictable income stream. SATA is available on most major brokerage platforms.</p>
