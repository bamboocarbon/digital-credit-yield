    ...
    <div>
      ...
      <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
        <div className="flex gap-5 text-xs" style={{ color: 'var(--text-muted)' }}>
          {[
            { color: '#22c55e', label: 'STRC', sub: 'Strategy · IPO Jul 2025' },
            { color: '#60a5fa', label: 'SATA', sub: 'Strive · IPO Nov 2025' },
          ].map(i => (
        ...
        <div style={cardStyle}>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={displayData} margin={{ top: 4, right: 20, left: 8, bottom: 55 }}>
              ...
              <Line type="monotone" dataKey="strc" name="STRC" stroke="#22c55e" strokeWidth={2} dot={false} activeDot={{ r: 3 }} connectNulls={false} />
              <Line type="monotone" dataKey="sata" name="SATA" stroke="#60a5fa" strokeWidth={2} dot={false} activeDot={{ r: 3 }} connectNulls={false} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      )}
