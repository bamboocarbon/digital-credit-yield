    ...
    Content() {
      return (
        <>
          ...
          <p><em>I track STRC, SATA and BMNP daily and hold positions in their parent issuers (MSTR and ASST). My honest read: the retrofit is working so far, but a dividend ratchet that&apos;s already been pulled once doesn&apos;t have infinite pulls left — worth watching closely if you&apos;re holding through this. Not financial advice.</em></p>
