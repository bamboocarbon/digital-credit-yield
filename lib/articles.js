    ...
    Content() {
      return (
        <>
          ...
          <ul>
            <li><strong>STRC</strong>: 11.50% annual yield — approximately $0.958 per share monthly, or $11.50 per year</li>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9em' }}>
              ...
              <tbody>
                ...
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  ...
                  <td style={{ padding: '0.75rem 1rem' }}>Monthly (semi-monthly change proposed; outcome not yet confirmed)</td>
                  <td style={{ padding: '0.75rem 1rem' }}>Daily (every NYSE business day, from June 16, 2026)</td>
                </tr>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
