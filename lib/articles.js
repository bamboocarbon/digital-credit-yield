...
export const articles = [
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.88em' }}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ padding: '0.6rem 0.9rem' }}>Semi-monthly (pending June 8, 2026 shareholder vote)</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  },
  {
    ...
    Content() {
      return (
        <>
          <p>BMNP is the 9.50% Series A Perpetual Preferred Stock issued by Bitmine Immersion Technologies, Inc., listed on the NYSE in June 2026. Its dividend structure departs meaningfully from both STRC and SATA: the rate is fixed at issuance rather than monthly-adjustable, payments are made weekly rather than monthly or daily, and the income is funded primarily by Ethereum staking rewards rather than a Bitcoin treasury. Understanding how the rate is set, how it can change, and what mechanisms protect investors if payments are delayed is essential for evaluating the instrument.</p>
    ...
    Content() {
      return (
        <>
          ...
          <h2>Payment frequency: weekly, semi-monthly, and daily</h2>
          <div style={{ overflowX: 'auto', margin: '1.5rem 0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9em' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid var(--accent-gold)' }}>
              ...
              <tbody>
                ...
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  ...
                  <td style={{ padding: '0.75rem 1rem' }}>Weekly (52 payments/year)</td>
