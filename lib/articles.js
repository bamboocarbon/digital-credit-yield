    ...
    Content() {
      return (
        <>
          ...
          <p>So Friday&apos;s message wasn&apos;t new information — it was the fine print all along. My honest read is that this is a marketing-versus-disclosure gap, not a deception: the pitch leaned on stability and the $100 anchor, while the legal document hedged every word of it. The lesson is the unglamorous one I keep coming back to — read the risk factors before you read the yield. I unpack how the par-defense mechanism is meant to work in <a href="/blog/how-strc-works">how STRC works</a> and the exact rate-setting framework in <a href="/blog/strc-vwap-dividend-mechanism">how STRC&apos;s rate is set</a>.</p>
          ...
          <p>Mostly, yes. The volatility is real, but on Thursday it was largely mechanical: a witching-day air pocket, deepened by leveraged holders being flushed, that both stocks recovered from within hours. And here&apos;s the part I find genuinely interesting. A forced-selling cascade hands the discount straight to whoever is patient enough to take the other side. If the price is going to keep snapping back toward $100, then STRC at $82.50 isn&apos;t only a fright — it&apos;s an 11.50% coupon bought on a far lower outlay, with a potential capital gain on top if it reverts to par, plus the dividends accruing the whole time. That asymmetry — limited downside if the par mechanism holds, a clear gain if it pulls back up — is the reward on offer to anyone willing to step in when others are being margin-called.</p>
          <p>The caveat I&apos;d hold onto: &quot;virtually recovered this time&quot; is not a guarantee, and STRC has spent stretches below par for weeks, not hours. The par anchor is an intention, not a promise — the prospectus says so itself. If you want to put numbers on the discount-to-par idea, the <a href="/strc/projector">Growth Projector</a> models it out, and the <a href="/strc/differentiator">comparison against Treasuries</a> is the honest yardstick for whether days like Thursday pay you enough.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p>The <a href="/strc/projector">STRC Growth Projector</a> lets you model what a given investment amount grows to over 1–20 years, with or without dividend reinvestment. It pre-fills the current live effective yield. The <a href="/strc/differentiator">vs Treasuries</a> page compares STRC against traditional income benchmarks on yield and projected growth, useful for seeing how it fits within a broader income strategy.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p>The number of NYSE business days varies by month, so the exact daily payment per share varies slightly from month to month. June 2026 is a partial period (June 16–30), with 10 qualifying business days. You can read more in our article on <Link href="/blog/monthly-vs-daily-dividends">monthly versus daily dividends</Link>.</p>
          ...
          <p>The <a href="/sata/projector">SATA Growth Projector</a> models what a given investment grows to over 1–20 years, with or without dividend reinvestment. From June 2026, the projector accounts for SATA's daily dividend structure, applying a 250-payment-per-year compounding model when reinvestment is enabled. The <a href="/sata/differentiator">vs Treasuries</a> page compares SATA against traditional income benchmarks on yield and projected growth over multiple time horizons.</p>
    ...
    Content() {
      return (
        <>
          ...
          <h2>Using the vs Treasuries comparison</h2>
          <p>The <a href="/strc/differentiator">STRC vs Treasuries</a> and <a href="/sata/differentiator">SATA vs Treasuries</a> pages compare each instrument against traditional income benchmarks on effective yield and projected growth over multiple time horizons. They are a useful starting point for understanding how each fits within a broader income portfolio.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p>For comparison with STRC&apos;s rules-based VWAP framework, see <Link href="/blog/strc-vwap-dividend-mechanism">How STRC&apos;s Dividend Rate Is Set</Link>. For SATA&apos;s discretionary mechanism, see <Link href="/blog/sata-dividend-rate-mechanism">How SATA&apos;s Dividend Rate Is Set</Link>. The <a href="/bmnp">BMNP hub</a> shows the live price and effective yield as the instrument begins trading.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p>The <a href="/bmnp">BMNP hub</a> on this site shows live price and effective yield as BMNP begins trading from June 10, 2026. For STRC and SATA, the <a href="/strc/differentiator">STRC vs Treasuries</a> and <a href="/sata/differentiator">SATA vs Treasuries</a> pages compare each instrument against traditional income benchmarks. For a more detailed look at how each instrument's dividend rate is set, see <Link href="/blog/strc-vwap-dividend-mechanism">STRC&apos;s VWAP mechanism</Link>, <Link href="/blog/sata-dividend-rate-mechanism">SATA&apos;s discretionary approach</Link>, and <Link href="/blog/bmnp-dividend-rate-mechanism">BMNP&apos;s fixed rate and compounding protection</Link>.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p>Where Strategy offers a menu of separate, side-by-side products, Metaplanet has built a layered structure with two named tiers stacked on top of one another.</p>
          ...
          <p><strong>The structure is layered rather than flat.</strong> Strategy sells several separate preferred products in parallel, each aimed at a slightly different buyer. Metaplanet has built a single ladder — senior MARS, middle MERCURY, ordinary shares at the bottom — which is closer to how a traditional company organises its finances. It is a tidier, more conventional arrangement, and arguably an easier one for a cautious investor to read.</p>
