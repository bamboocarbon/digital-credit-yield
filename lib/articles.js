    ...
    Content() {
      return (
        <>
          ...
          <p>Strategy (formerly MicroStrategy) began as a business intelligence software company but has repositioned itself primarily as a Bitcoin treasury company. Its core strategy is to accumulate Bitcoin as its principal asset, financing those purchases through a mix of debt instruments, ordinary share issuance, and preferred equity. STRC is one of those preferred equity instruments — capital raised in exchange for a fixed income stream, with the proceeds used to fund continued Bitcoin acquisition.</p>
          <p>Issuing preferred equity allows Strategy to raise capital without diluting ordinary shareholders through new share issuance and without creating the hard repayment obligations that come with debt. For investors, STRC offers a fixed, high cash yield from one of the most prominent names in the Bitcoin space.</p>
          ...
          <p>These step-ups reflect both the adjustable-rate mechanism responding to market conditions and Strategy's commitment to maintaining a competitive yield for preferred shareholders.</p>
    ...
    Content() {
      return (
        <>
          ...
          <ol>
            <li><strong>Ordinary share issuance</strong> — raises cash but dilutes existing shareholders</li>
            ...
            <li><strong>Preferred equity</strong> — instruments like STRC and SATA that raise capital at a fixed yield without diluting ordinary shareholders and without the hard repayment obligations of debt</li>
          </ol>
          ...
          <p>Strategy (formerly MicroStrategy) began accumulating Bitcoin in August 2020 under CEO Michael Saylor, becoming the first major publicly traded company to adopt Bitcoin as a primary treasury reserve asset. It now holds over 500,000 BTC — more than any other publicly traded company — and has financed this accumulation through a range of capital market instruments.</p>
          ...
          <p>Strive Asset Management is a newer entrant, founded in 2022, with an investment approach built around direct Bitcoin exposure and maximising shareholder returns. SATA is its preferred equity instrument, combining a Bitcoin-backed treasury with a conservative cash reserve policy designed to provide dividend security.</p>
    ...
    Content() {
      return (
        <>
          ...
          <h2>Stated yield versus effective yield</h2>
          <p><strong>Stated yield</strong> (also called nominal yield or coupon rate) is the annual dividend expressed as a percentage of the par value — the price the instrument was originally issued at. If a preferred share has a $100 par value and pays $13 per year in dividends, its stated yield is 13%.</p>
          <p><strong>Effective yield</strong> (also called current yield or running yield) is the annual dividend expressed as a percentage of the <em>current market price</em>. If that same share is trading at $95, the effective yield is 13 ÷ 95 × 100 = 13.68%. If it is trading at $106, the effective yield is 13 ÷ 106 × 100 = 12.26%.</p>
          ...
          <p>The <a href="/strc/projector">Growth Projector</a> uses effective yield to model portfolio growth. When dividend reinvestment is toggled on, it assumes reinvested dividends purchase additional shares at the current effective yield. This means the compounding model reflects what a buyer at today's price would actually earn — not a theoretical par-based return. Even small differences in effective yield produce meaningfully different outcomes over ten or twenty year horizons, which is why tracking it accurately matters.</p>
    ...
    Content() {
      return (
        <>
          ...
          <h2>Who is Strive?</h2>
          <p>Strive Asset Management is a US-based investment firm founded in 2022 with an approach centred on maximising shareholder returns through direct asset exposure. The firm has positioned itself around Bitcoin as a core long-term asset and manages capital with a focus on clear, outcomes-driven investment. SATA is Strive's preferred equity instrument — a publicly traded security designed to generate high, sustainable cash income for investors seeking monthly (and soon daily) dividends.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p><strong>STRC</strong> is issued by <strong>Strategy</strong> (formerly MicroStrategy), led by Michael Saylor. Strategy holds over 500,000 Bitcoin — more than any other publicly traded company — and has built its identity around Bitcoin accumulation as a corporate strategy. STRC is one of several capital-raising instruments Strategy uses to fund continued Bitcoin purchases.</p>
          ...
          <p>STRC is backed by Strategy's financial resources — including its 500,000+ Bitcoin holdings, business revenues from its software operations, and its ongoing access to capital markets. Strategy is a large, well-established public company with a long track record in the capital markets.</p>
