...
export const articles = [
  {
    ...
    metaTitle: "Strategy's Digital Credit Capital Framework",
    date: '2026-06-30',
    excerpt: "STRC fell from par to the low $70s in five weeks — the 'never sell' promise broken, the ATM flywheel seized. Then Strategy announced its Digital Credit Capital Framework: a ring-fenced reserve, a Bitcoin monetisation programme, a 12% rate and buybacks. Here's what it says.",
    readTime: '7 min read',
    category: ['STRC'],
    Content() {
      return (
...

  {
    ...
    Content() {
      return (
        <>
          <p>From June 2026, SATA becomes one of the first listed securities to pay a dividend every single trading day — not quarterly, not monthly, but daily. It sounds like a real upgrade, and it makes for a great headline. So here is my answer to the question in the title, up front: for most people, the frequency barely matters. What you do with the income — reinvest it or spend it — swamps how often it arrives. Let me walk through why, because the gap between the marketing and the maths is the interesting part.</p>
          ...
          <p><em>I track STRC and SATA daily and hold positions in their parent issuers (MSTR and ASST) rather than the preferreds themselves. My take is that daily dividends are a nice-to-have, not a reason to buy — but that is my view, not financial advice.</em></p>
    ...
    Content() {
      return (
        <>
          ...
          <p>With reinvestment off, you&apos;re looking at a flat value line and a steadily climbing cumulative-income figure underneath it. That is the real picture of an income stream: your share count is fixed, so if the price stays near par your portfolio value sits roughly still while the cash you&apos;ve collected ticks up. On $50,000 at STRC&apos;s 11.50%, that&apos;s about $5,750 a year — $57,500 over a decade, with your original stake still in shares throughout. If you&apos;re drawing the income to live on, this is the line you care about, and the projector makes it easy to check whether that annual figure clears your target.</p>
    ...
    Content() {
      return (
        <>
          ...
          <p><em>I track STRC and SATA daily and hold positions in their parent issuers (MSTR and ASST). My take is that these frequency changes matter far less than they look — useful if you reinvest, neutral if you don&apos;t. Not financial advice.</em></p>
  ...
  {
    slug: 'working-backwards-strc-reverse-play',
    title: "Working Backwards: Inside Strategy's Reverse Play to Save STRC",
    metaTitle: "Working Backwards: Strategy's Reverse Play to Save STRC",
    date: '2026-08-06',
    excerpt: "STRC touched $71.25 on 26 June, nearly 29% below par. Six weeks on it's back around $94 — not because the original flywheel restarted, but because Strategy is running it backwards: selling Bitcoin to buy back STRC instead of selling STRC to buy Bitcoin. Here's how that retrofit works and whether it holds.",
    readTime: '10 min read',
    category: ['STRC'],
    Content() {
      return (
        <>
          <p>I&apos;ve followed STRC closely since it launched, and for most of its first year it did exactly what it said on the tin. STRC, Strategy&apos;s preferred stock, was engineered to sit close to its $100 stated amount, and for a long stretch it did. Then June arrived, Bitcoin slid under $60,000, and the whole mechanism came under a strain I hadn&apos;t seen it tested against before. On the 26th of June, STRC touched an intraday low of $71.25 — nearly 29% below its designed level. Six weeks on, it has clawed most of that ground back, trading around $94 this week. The story of how it got there, and where Strategy is likely to take it next, tells you a lot about how this whole capital structure is actually meant to work under pressure.</p>

          <h2>Why it fell so far</h2>
          <p>STRC&apos;s price is supposed to be self-correcting. When it trades above $100, Strategy sells fresh shares into the market through an at-the-market programme and uses the proceeds to buy more Bitcoin. When it drifts below $100, the effective yield rises automatically — the same dividend paid on a lower price — and that higher yield is meant to pull buyers back in and drive the price back toward par. That mechanism had worked, more or less, since launch in July 2025.</p>
          <p>June broke it. Bitcoin&apos;s slide below $60,000 dragged STRC down with it, and for the first time since Strategy began accumulating Bitcoin back in 2022, the company sold a small amount of it — just 32 coins, worth around $2.5 million — to help fund a preferred dividend payment. That single disclosure did more damage to sentiment than the sum itself suggested, more than I think the numbers actually justified. It confirmed the fear that had been building in the background: that Strategy&apos;s newer, richer capital structure could eventually eat into the one thing the whole model exists to protect: Bitcoin. STRC fell below par, which automatically paused the at-the-market issuance programme, cutting off one of the main channels Strategy uses to keep buying Bitcoin. The stock kept falling for four straight sessions into the 26th of June low, all while the dividend rate itself sat unchanged at 11.5%, where it had been held since March.</p>

          <h2>The recovery, and the reverse gear</h2>
          <p>The response came three days later. On the 29th of June, Strategy announced a broader Digital Credit Capital Framework and, as one plank of it, lifted the STRC dividend by half a point to 12%, effective for the periods beginning the 1st of July. That took the rate to its highest level since launch and was the first genuinely incentive-driven rise in the stock&apos;s history — every previous increase had followed the standard ratchet, whereas this one arrived bundled with fresh buyback authority and the Bitcoin monetisation plan specifically to draw buyers back in after the crash. The market noticed immediately: STRC rose close to 10% in the days that followed, though it remained well short of par.</p>
          <p>What&apos;s happened since is, in effect, the mechanism running backwards. Rather than issuing new STRC shares to buy Bitcoin, Strategy has been selling small amounts of Bitcoin to buy back STRC. Between the end of June and early August the company sold 5,226 Bitcoin across three separate transactions for combined proceeds of roughly $321 million, most recently 1,638 coins between the 27th of July and the 2nd of August at an average price near $63,957, which took total holdings down to 842,138 BTC. Some of that cash, alongside a slice of fresh MSTR common stock issuance, has gone straight into buying back STRC itself: 912,143 shares repurchased in that same week for $81.2 million, an average price of roughly $89, comfortably below the $100 stated amount. Strategy still has $893.8 million of capacity left under the buyback programme it opened in late June.</p>
          <p>That 12% rate has since held firm through August rather than being lifted further, and management has been explicit that it won&apos;t be cut until STRC demonstrates sustained trading at or near $100. CEO Phong Le has said as much directly: the corporate objective is for the stock to trade in the $99 to $100 range over time, not just to touch it briefly.</p>
          <p>Put the two forces together and the logic is straightforward, and it&apos;s one I find easy enough to follow even if it&apos;s unusual to watch play out in real time. Sell a little Bitcoin, use the proceeds alongside some fresh MSTR stock to buy back STRC below par, hold the dividend high enough to keep attracting buyers, and let the reduced float and steady income pull the price back toward $100. It is, quite literally, the opposite of the engine STRC was built to run. Instead of Bitcoin purchases funding preferred issuance, preferred buybacks are being funded partly by Bitcoin sales.</p>

          <h2>Where this likely goes from here</h2>
          <p>The destination is obvious even if the timing isn&apos;t: get STRC sustainably back through $100, then flip the switch back to the original design. Once that happens, the at-the-market programme reopens, new STRC shares get sold at or above par, and the proceeds go back into buying Bitcoin rather than clawing it back. That is the entire point of closing the gap quickly — every month spent below par is a month where Strategy is running down its Bitcoin stack and its cash reserve rather than growing either.</p>
          <p>My best guess, going by the pattern so far, is more of the same rather than anything dramatic. Continued modest Bitcoin sales to fund further buybacks, continued use of MSTR common stock issuance to spread the funding load rather than leaning on Bitcoin sales alone, and the dividend held at 12% as the carrot that keeps demand coming in. With $893.8 million still available under the repurchase programme, there is plenty of room to keep pressing the price higher without needing a dramatic policy change. The closer STRC gets to par, the less Bitcoin needs to be sold to finish the job — the reduced float from the buybacks and the price&apos;s own momentum start doing more of the work, even as the elevated effective yield that helped pull buyers back in cools down toward the 12% headline rate.</p>
          <p>The one thing I&apos;m watching is the ratchet mechanism itself. It has already been used once without producing a lasting recovery, and analysts have pointed out that a structure like this only has so many cycles in it before it stops being credible. Competition hasn&apos;t gone away either — Strive&apos;s SATA continues to offer a higher yield with daily payouts and no underlying debt, which puts a ceiling on how much breathing room STRC has even as it climbs back toward par. The direction of travel looks right. Whether it gets there before Bitcoin itself decides otherwise is the part nobody can promise.</p>

          <h2>Was reverse ever part of the plan?</h2>
          <p>It&apos;s worth stepping back and asking myself whether any of this was actually envisaged when STRC was designed. The evidence points to no — not in the sense of a mechanism sitting ready in reserve, waiting to be switched on.</p>
          <p>The instrument that priced in July 2025 was built to run in one direction only. Sell preferred shares above par, take the proceeds straight into Bitcoin, and let a rising dividend do the work of pulling the price back to par whenever it drifted below. That was the entire engineering brief, and it sat on top of a broader company doctrine that had held since 2020: Bitcoin, once bought, simply wasn&apos;t sold. Not through the 2022 downturn, not through any of the drawdowns since. The prospectus carried the standard risk-factor language — that Strategy&apos;s efforts to defend the $100 stated amount might fail, or that the board could choose not to pay a dividend at all — but that&apos;s a warning that the forward gear might one day stall, not a design for a reverse one.</p>
          <p>The first hint that something different was being contemplated came on the Q1 2026 earnings call, when Saylor mentioned the company might sell a small amount of Bitcoin &quot;to inoculate the market&quot; — at the time, it read more like a rhetorical hedge than a policy shift. When the sale actually happened at the end of May, just 32 coins for about $2.5 million, it still landed as a genuine shock, because it was the first Bitcoin disposal since December 2022 and it broke a doctrine investors had priced in as close to absolute. June then did the rest: Bitcoin below $60,000, a $1.5 billion convertible note buyback draining part of the cash reserve, and forced selling among leveraged STRC holders compounding the slide down to $71.25.</p>
          <p>The Digital Credit Capital Framework that followed three days later wasn&apos;t a plan pulled out of a drawer. It was assembled under pressure — formal authority to sell Bitcoin for corporate obligations, two buyback programmes, and a dividend increase, all bolted together inside a single announcement. STRC was built to run in one direction only: capital in, Bitcoin out, price defended by yield alone. What&apos;s happening now is closer to turning that motor into a generator than flicking a switch that was already there — Bitcoin out, capital in, price defended by direct purchases rather than the dividend doing all the work. It&apos;s a retrofit, built in real time under a market that was actively testing whether the doctrine would hold. Whether a motor engineered for one direction can be run as a generator indefinitely, without something in the winding eventually giving out, is really the open question sitting underneath everything else in this piece.</p>
          <p>That engineering comparison holds up in the detail, too. A motor run backwards doesn&apos;t generate power on its own — it needs an outside source to excite it first, which is exactly the role fresh MSTR stock issuance is playing alongside the Bitcoin sales, since Bitcoin proceeds alone haven&apos;t been enough to fund the buybacks. The process also runs leakier than the machine was designed for: Bitcoin is being sold at a discount to defend a stock trading at a discount, so value bleeds from both sides of the trade rather than one. And components sized for one direction of duty wear faster running the other way, which is close to what analysts mean when they warn the dividend ratchet only has so many cycles left in it before it stops doing its job. None of that makes the retrofit the wrong call. It just means it was never going to be free.</p>

          <h2>Where to look next</h2>
          <p>The <a href="/strc">STRC hub</a> tracks the live price and effective yield day to day, and I broke down the Digital Credit Capital Framework announcement itself in <a href="/blog/strategy-transforms">Strategy Transforms</a> if you want the full detail behind the 12% rate rise and the buyback authorisation.</p>

          <p><em>I track STRC, SATA and BMNP daily and hold positions in their parent issuers (MSTR and ASST). My view: the retrofit is working so far, but a dividend ratchet that&apos;s already been pulled once doesn&apos;t have infinite pulls left — worth watching closely if you&apos;re holding through this. Not financial advice.</em></p>

          <p className="disclaimer">This article is for educational purposes only and does not constitute financial advice. STRC is a speculative investment tied to Strategy&apos;s Bitcoin holdings and capital structure. All rates, prices and figures cited are subject to change. Always consult a qualified financial adviser before making investment decisions.</p>
        </>
      );
    },
  },
  {
    slug: 'how-chad-works',
    title: "How CHAD Works: DeFi Development Corp's Solana-Backed Preferred Stock",
    metaTitle: 'How CHAD Works: Solana Preferred Stock',
    date: '2026-09-25',
    excerpt: "CHAD closed its IPO on 8 September at $8 a share, a $10 stated value and a 13% rate — the fourth instrument I track here, and the first backed by Solana rather than Bitcoin or Ethereum. Here's the company behind it, how the dividend works, and what's actually funding it.",
    readTime: '7 min read',
    category: 'CHAD',
    Content() {
      return (
        <>
          <p>Every other instrument I track here is a Bitcoin or Ethereum story. CHAD isn&apos;t — it&apos;s Solana. DeFi Development Corp. closed the IPO of its Variable Rate Series C Perpetual Preferred Stock on 8 September 2026: 1,375,000 shares at $8.00 each, roughly $11 million gross, followed by an over-allotment close on 21 September that brought in a further $1.65 million. Against STRC&apos;s billions and even BMNP&apos;s hundreds of millions, that&apos;s a genuinely small raise. But the structure is the same familiar playbook — sell preferred stock, buy the underlying crypto asset — applied to a company and a coin I hadn&apos;t covered before, so this is a look at how it&apos;s built.</p>

          <h2>The company behind it</h2>
          <p>DeFi Development Corp. (Nasdaq: DFDV) is not a company that started life doing this. Until April 2025 it was Janover Inc., a small real-estate financing platform founded in 2018 that connected commercial property buyers with lenders — about as far from crypto treasury management as a listed company gets. A group of former Kraken executives took it over, rebranded it, and pointed the balance sheet at Solana instead. The company now runs its own Solana validator and offers staking-as-a-service alongside its treasury holdings, which gives it a genuine operating business layered on top of simply holding SOL — closer to Bitmine&apos;s ETH-staking model than to Strategy&apos;s pure buy-and-hold approach. As of 21 September 2026 the treasury held approximately <strong>2,490,304 SOL</strong>, the second-largest public Solana treasury after Forward Industries, after adding roughly 101,000 SOL in the week following the CHAD raise.</p>

          <h2>A $10 stated value, not $100</h2>
          <p>The first thing to flag if you&apos;re used to STRC, SATA or BMNP: CHAD&apos;s stated (par) value is <strong>$10 a share</strong>, not $100. Every dollar figure scales down by a factor of ten, but the mechanics are otherwise the same family. It priced at $8.00 — a 20% discount to par, the same playbook Strive used for SATA and Bitmine used for BMNP — carrying an initial dividend rate of <strong>13.00%</strong>. On the stated value that&apos;s $1.30 a share a year; against the $8.00 offer price it works out to an effective yield of roughly <strong>16.25%</strong> at issue, the highest headline figure of the four I track, for taking on the newest and smallest of the four companies.</p>

          <h2>Daily dividends from day one</h2>
          <p>CHAD skips the monthly-then-semi-monthly-then-daily progression STRC and SATA went through and launches straight into <strong>daily, cumulative dividends</strong> — regular dividends accrue every calendar day from the issuance date and are paid on business days, roughly 250 payments a year. The first payment is a single lump sum on <strong>1 October 2026</strong>, covering the stub period from issuance through the 30 September record date, before settling into the ordinary daily rhythm. It&apos;s the same daily structure SATA moved to in June, just adopted from the outset rather than retrofitted.</p>

          <h2>A variable rate, aimed at a tight trading band</h2>
          <p>The rate isn&apos;t fixed the way BMNP&apos;s is, and it isn&apos;t governed by STRC&apos;s published VWAP-band rulebook either. DeFi Development Corp. has given itself discretion to adjust the CHAD rate, with a stated intention of keeping the share price inside a narrow <strong>$9.95–$11.00</strong> range around the $10 stated value — tighter than SATA&apos;s $99–$101 intention on a like-for-like basis. It&apos;s the same underlying idea as STRC and SATA&apos;s rate mechanisms — move the coupon to hold the price near par — just applied to a much newer, thinner-traded stock, which is exactly where I&apos;d expect the band to be tested hardest in the early months.</p>

          <h2>An $11 redemption option on top</h2>
          <p>CHAD also has a redemption feature, much like BMNP&apos;s <a href="/blog/bmnp-dividend-rate-mechanism">redemption premium</a>. DeFi Development Corp. can buy back all or part of the stock at <strong>$11.00 a share</strong> plus any unpaid dividends, or more if it chooses. That&apos;s 110% of the $10 stated value, and the right has applied at any time since CHAD listed on Nasdaq. Unlike BMNP&apos;s ladder, which steps down from 110% to 105% and then to par, CHAD&apos;s $11 has no step-down and no time limit. It isn&apos;t the only way out either: the company can also redeem at the $10 stated value if a tax event hits or fewer than 25% of all CHAD shares ever issued remain outstanding.</p>
          <p>The $11 figure is the same as the top of that $9.95–$11.00 target band, and I don&apos;t think that&apos;s a coincidence. Above $11 a buyer risks having the shares bought back at less than they paid, which puts a natural ceiling on the price. Below it, anyone who bought near the $8 IPO price would get a 37.5% gain on cost if the company ever used the option. Two caveats: this is the company&apos;s choice, not yours, and there&apos;s no right for holders to sell back at $11. The only holder put is a repurchase at the $10 stated value if a fundamental change such as a takeover occurs.</p>

          <h2>What's actually funding the dividend</h2>
          <p>DFDV describes what it calls a &quot;capital flywheel&quot;: raise capital through CHAD, buy SOL, earn yield on it, grow SOL-per-share, repeat. The prospectus discloses staking yields of 7–8% during 2025 from delegating SOL to third-party validators and running its own nodes — a real income stream, in the same spirit as BMNP&apos;s ETH-staking backing. CEO Joseph Onorati has said the company is &quot;returning twice as much as SOL&quot; quarter-to-date, pointing to that yield plus active treasury management on top of raw price appreciation. That said, the filings are careful not to promise staking income will directly fund the cash dividend — proceeds from CHAD itself, and from further capital raises including the newly established <strong>$300 million CHAD ATM programme</strong>, are earmarked mainly for buying more SOL, with dividends funded from whatever capital is legally available at the time.</p>
          <p>There is one dedicated cushion, though. At closing DFDV put <strong>$1.30 for every CHAD share issued</strong> into a separate <strong>12-month dividend reserve</strong>, funded from existing cash, financial instruments or digital assets. That covers a full year of dividends at the initial 13% rate. It&apos;s the same idea as the cash reserves behind STRC and SATA, on a much smaller scale. The prospectus attaches caveats, and I&apos;d take them seriously. The reserve isn&apos;t a guarantee. DFDV isn&apos;t required to top it up if the rate rises above 13% or more shares are sold through the ATM. And in an insolvency, the money in that account could still be reached by creditors. DFDV presents the reserve, the $11 redemption option above and the staking yield on its SOL as separate tools for managing CHAD in different market conditions. That seems fair to me, as long as you remember that none of them is a promise.</p>

          <h2>The risk that's different here</h2>
          <p>Solana is simply more volatile than Bitcoin or Ethereum day to day, and DFDV&apos;s own prospectus notes SOL traded between roughly $95 and $295 in the trailing twelve months — close to a threefold range. That volatility runs straight through to CHAD: a tighter $9.95–$11.00 trading band is harder to defend against a more volatile underlying asset than STRC or SATA&apos;s wider tolerance is against Bitcoin. Add a company two years removed from being a real-estate fintech, an IPO measured in millions rather than hundreds of millions, and a preferred stock with only weeks of trading history, and CHAD is the instrument here I&apos;d treat as the most speculative by some distance — which the near-16% starting effective yield is compensating you for, not concealing.</p>

          <h2>Where to look next</h2>
          <p>The <a href="/chad">CHAD hub</a> carries the live price and effective yield, the <a href="/glossary">glossary</a> has the par-value and effective-yield definitions in one place across all four tickers, and I covered the broader Bitcoin-treasury playbook that BMNP and now CHAD both borrow from in <a href="/blog/bitcoin-treasury-companies">Bitcoin treasury companies</a>.</p>

          <p><em>I track STRC, SATA, BMNP and CHAD daily and hold positions in their parent issuers (MSTR and ASST), but not in DeFi Development Corp. CHAD is the newest and smallest instrument here, so treat the above as my early read of the filings rather than a settled view — and check the prospectus yourself before sizing a position. Not financial advice.</em></p>

          <p className="disclaimer">This article is for educational purposes only and does not constitute financial advice. CHAD is a newly issued, thinly traded instrument and Solana is a highly volatile asset. Rate and structural details are based on publicly available SEC filings as of September 2026 and are subject to change. Always consult a qualified financial adviser before making investment decisions.</p>
        </>
      );
    },
  },
  {
    slug: 'strc-365-day-calendar-dividends-proposal',
    title: 'STRC Goes Daily (Again): Inside Strategy’s 365-Day Calendar Dividend Proposal',
    metaTitle: "Strategy's 365-Day Dividend Proposal Explained",
    date: '2026-09-25',
    excerpt: "Strategy wants to pay dividends on all four of its listed preferred stocks every calendar day of the year, weekends and holidays included. For STRC that means moving from 24 payments a year to 365 — pending a shareholder vote on 28 October. Here's what changes, what doesn't, and why.",
    readTime: '5 min read',
    category: ['STRC'],
    Content() {
      return (
        <>
          <p>STRC has already changed its payment schedule once this year — I covered the move from monthly to semi-monthly back in <a href="/blog/strc-sata-dividend-frequency-changes-june-2026">June</a>. Now Strategy wants to go much further. On 25 September 2026 the company proposed moving all four of its Nasdaq-listed preferred stocks — STRF, STRC, STRK and STRD — onto a schedule where every single calendar day, including weekends and holidays, becomes a dividend record date, with the dividend paid the next business day. Strategy is calling it the first global security with calendar-day accruals and dividends. It still needs a shareholder vote, so this is a proposal, not yet a fact — but it&apos;s worth understanding now, because if it passes, STRC&apos;s payment rhythm changes again within weeks.</p>

          <h2>What's actually proposed</h2>
          <p>The change is purely mechanical: dividends would accrue on every calendar day of the year rather than only on business days, and be paid on the next available business day after declaration. Strategy has been explicit that this &quot;will not change the dividend rates, total regular dividends, or the company&apos;s overall dividend payment obligations&quot; for any of the four securities. Nothing about what you earn in a year moves — only how many pieces it&apos;s split into and how the calendar around it works.</p>

          <h2>What changes for each security</h2>
          <div style={{ overflowX: 'auto', margin: '1.5rem 0' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9em' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid var(--accent-gold)' }}>
                  <th style={{ textAlign: 'left', padding: '0.6rem 1rem', color: 'var(--accent-gold)' }}>Security</th>
                  <th style={{ textAlign: 'left', padding: '0.6rem 1rem', color: 'var(--accent-gold)' }}>Current frequency</th>
                  <th style={{ textAlign: 'left', padding: '0.6rem 1rem', color: 'var(--accent-gold)' }}>Proposed frequency</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  <td style={{ padding: '0.6rem 1rem', color: 'var(--text-muted)' }}><strong>STRC</strong> (the one I track, 12.00% variable)</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Semi-monthly, 24 payments a year</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Daily, 365 record dates a year</td>
                </tr>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  <td style={{ padding: '0.6rem 1rem', color: 'var(--text-muted)' }}><strong>STRF</strong> (10% fixed)</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Quarterly, 4 payments a year</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Daily, 365 record dates a year</td>
                </tr>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  <td style={{ padding: '0.6rem 1rem', color: 'var(--text-muted)' }}><strong>STRK</strong> (8% fixed)</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Quarterly, 4 payments a year</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Daily, 365 record dates a year</td>
                </tr>
                <tr>
                  <td style={{ padding: '0.6rem 1rem', color: 'var(--text-muted)' }}><strong>STRD</strong> (10% fixed)</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Quarterly, 4 payments a year</td>
                  <td style={{ padding: '0.6rem 1rem' }}>Daily, 365 record dates a year</td>
                </tr>
              </tbody>
          ...
          <p>STRC&apos;s jump is the smaller of the two in relative terms — 24 to 365 — but STRF, STRK and STRD are being asked to jump roughly ninety-fold, from four record dates a year to 365. Only STRC is tracked on this site, but the scale of change across the other three is a useful sense of how far this goes if shareholders approve it.</p>

          <h2>Key dates</h2>
          <ul>
            <li><strong>25 September 2026</strong> — Proposal announced; record date set for the shareholder vote</li>
            <li><strong>28 October 2026</strong> — Special shareholder vote</li>
            <li><strong>1 November 2026</strong> — STRC&apos;s first daily record date, if approved</li>
            <li><strong>2 November 2026</strong> — STRC&apos;s first payment under the new schedule</li>
            <li><strong>31 December 2026</strong> — STRF, STRK and STRD pay their final quarterly dividend on the old schedule</li>
            <li><strong>4 January 2027</strong> — STRF, STRK and STRD&apos;s first payment under the daily schedule</li>
          </ul>

          <h2>Why bother</h2>
          <p>Strategy&apos;s stated reasoning is about volatility and utility rather than yield. The argument is that the more often a security pays and reprices, the steadier its valuation looks — useful for fund managers who need clean month-end marks, for institutions using the preferreds as a cash-management tool, and potentially for qualifying under low-volatility index rules or getting better collateral haircuts at prime brokers. None of that changes what a retail holder actually receives over a year; it&apos;s aimed squarely at the institutional plumbing around the stock.</p>

          <h2>My view</h2>
          <p>I wrote in June that STRC&apos;s move to semi-monthly wouldn&apos;t change the economics, only the rhythm, and the same logic holds here at a bigger scale. What I think is genuinely different this time is what it does to the demand-bunching dynamic I described in <a href="/blog/storm-in-a-teacup">A Storm in a Teacup</a> — when STRC paid monthly, buyers piled in around a single record date every month, and that recurring spike was part of what pulled the price back toward par. Spread that demand across 365 record dates instead of 24, and there&apos;s no single date left to concentrate around at all. That could smooth the price further, which is the stated goal — or it could weaken the very demand-capture flywheel that used to help defend par, now that there&apos;s no obvious day to capture. I don&apos;t think anyone, including Strategy, fully knows which effect wins out until it&apos;s tried. Either way, this is still a proposal: it needs a shareholder vote on 28 October before any of it takes effect, and the dates above could shift if that vote doesn&apos;t go the way Strategy expects.</p>

          <h2>Where to look next</h2>
          <p>The <a href="/strc">STRC hub</a> will reflect the new schedule if and when it takes effect, and I covered the earlier frequency change in full in <a href="/blog/strc-sata-dividend-frequency-changes-june-2026">STRC goes semi-monthly and SATA goes daily</a>.</p>

          <p><em>I track STRC, SATA, BMNP and CHAD daily and hold a position in Strategy&apos;s parent company (MSTR). This is a proposal pending a shareholder vote, not a confirmed change, and I&apos;ll update this once the 28 October vote is decided. Not financial advice.</em></p>

          <p className="disclaimer">This article is for educational purposes only and does not constitute financial advice. The dividend schedule change described here is a proposal subject to shareholder approval and could be delayed, amended or rejected. Always consult a qualified financial adviser before making investment decisions.</p>
        </>
      );
    },
  },
