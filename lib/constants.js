...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    display: '$204.2M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Sep 14, 2026',
    source: 'https://www.sec.gov/Archives/edgar/data/0001920406/000162828026061682/asst-20260914.htm',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$334M/yr',
    note: 'Staking payouts fuel the dividend — current-rate annualized from 5.067M ETH staked (85% of 5.96M ETH holdings) via MAVAN, 2.62% 7-day yield · disclosed Sep 14, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-96-million-tokens-and-total-crypto-and-total-cash-holdings-of-15-8-billion-302877149.html',
  },
};
