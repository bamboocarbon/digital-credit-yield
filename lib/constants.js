...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    source: 'https://decrypt.co/378190/strive-bitcoin-25000-btc-after-buy',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$334M/yr',
    note: 'Staking payouts fuel the dividend — current-rate annualized from ~5.1M ETH staked (85% of 5.96M ETH holdings) via MAVAN, 2.62% 7-day yield · disclosed Sep 13, 2026',
