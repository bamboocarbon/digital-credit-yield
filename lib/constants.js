...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    display: '$204.2M',
    note: 'Pure cash figure (excludes 505,000 STRC shares held) · disclosed Sep 14, 2026',
    source: 'https://coingape.com/strive-adds-469-bitcoin-for-36-6-million-holdings-reach-25000-btc/',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$334M/yr',
    // Frozen to its own disclosure date on purpose — 5.067M staked = 85% of 5.96M
    // was true specifically as of Sep 14, 2026, and would go arithmetically
    ...
    source: 'https://cointelegraph.com/news/bitmine-5-million-eth-staked-334-million-revenue',
  },
  CHAD: {
