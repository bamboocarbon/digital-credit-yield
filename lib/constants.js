...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$4.80B',
    note: '~2.5 years of preferred dividend & interest coverage · disclosed Aug 16, 2026',
  ...
  BMNP: {
    ...
    display: '$250M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.067M ETH staked (~87% of holdings) via MAVAN · disclosed Aug 16, 2026',
