...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    display: '$154.8M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Aug 17, 2026',
    source: 'https://cryptobriefing.com/strive-buys-79-bitcoin-20246-btc/',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$250M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.07M ETH staked (~87% of holdings) via MAVAN · disclosed Aug 16, 2026',
