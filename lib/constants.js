...
export const STRIVE_BTC_HOLDINGS = '25,000';
...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$5.10B',
    note: '~2.9 years of preferred dividend & interest coverage · disclosed Aug 23, 2026',
    source: 'https://www.sec.gov/Archives/edgar/data/0001050446/000119312526361845/mstr-20260824.htm',
  },
  SATA: {
    label: 'Cash & Equivalents',
    display: '$229.6M',
    note: 'Pure cash figure (excludes Strive\'s STRC preferred holdings) · disclosed Sep 18, 2026',
    source: 'https://kalkinemedia.com/us/news/announcements/strive-inc-acquires-1355-bitcoin-at-average-price-near-79475-updates-holdings-as-of-september-18-2026',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$357M/yr',
    note: 'Staking payouts fuel the dividend — current-rate annualized from 5.067M ETH staked via MAVAN, 2.62% 7-day yield · disclosed Sep 22, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-98-million-tokens-and-total-crypto-and-total-cash-holdings-of-17-1-billion-302884434.html',
  },
};
