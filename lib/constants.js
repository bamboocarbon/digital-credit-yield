...
export const STRIVE_BTC_HOLDINGS = '20,000';
...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$3.75B',
    note: '~2.1 years of preferred dividend & interest coverage · disclosed Jul 26, 2026',
    source: 'https://www.stocktitan.net/sec-filings/MSTR/8-k-strategy-inc-reports-material-event-a741a59a93bf.html',
  },
  SATA: {
    label: 'Cash & Equivalents',
    display: '$154M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Jul 24, 2026',
    source: 'https://www.stocktitan.net/sec-filings/ASST/8-k-strive-inc-reports-material-event-12204ed099be.html',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$254M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~4.92M ETH staked (~85% of holdings) via MAVAN · disclosed Jul 26, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-79-million-tokens-and-total-crypto-and-total-cash-holdings-of-11-8-billion-302834876.html',
  },
};
