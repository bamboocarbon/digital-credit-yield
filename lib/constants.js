...
export const DIVIDEND_RESERVE = {
  ...
  BMNP: {
    ...
    display: '$250M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.067M ETH staked (~87% of holdings) via MAVAN at 2.61% 7-day yield · disclosed Aug 18, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-82-million-tokens-and-total-crypto-and-total-cash-holdings-of-11-4-billion-302852583.html',
  },
};
