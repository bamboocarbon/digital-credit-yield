...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$5.1B',
    note: '~2.7 years of preferred dividend & interest coverage · disclosed Aug 24, 2026',
    source: 'https://coinpaper.com/34336/mstr-stock-jumps-2-as-strategy-extends-bitcoin-buying-pause-to-eighth-week',
  },
  SATA: {
    label: 'Cash & Equivalents',
    display: '$171.9M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Aug 24, 2026',
    source: 'https://cryptobriefing.com/strive-buys-1110-bitcoin-21356-btc-total/',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$330M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.07M ETH staked (~87% of 5.85M holdings) via MAVAN · disclosed Aug 23, 2026',
    source: 'https://www.thailand-business-news.com/pr-news/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-85-million-tokens-and-total-crypto-and-total-cash-holdings-of-14-9-billion',
  },
};
