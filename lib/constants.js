...
export const STRIVE_BTC_HOLDINGS = '24,531';
...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    display: '$202.6M',
    note: 'Part of a blended reserve (12mo cash + 6mo STRC holdings); cash-only figure shown · disclosed Sep 8, 2026',
    source: 'https://crypto.news/strive-adds-109m-in-bitcoin-through-sata-funding/',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$330M/yr',
    note: 'Staking payouts fuel the dividend — current-rate annualized from 5.067M ETH staked (85.5% of 5.93M ETH holdings) via MAVAN, 2.61% 7-day yield · disclosed Sep 7, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-93-million-tokens-and-total-crypto-and-total-cash-holdings-of-15-7-billion-302871960.html',
  },
};
