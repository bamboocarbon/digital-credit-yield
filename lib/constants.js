...
export const STRIVE_BTC_HOLDINGS = '20,167';
...
export const BMNP_DIVIDEND_SCHEDULE = [
  ...
  // Declared Aug 14, 2026 (8-K): 17 payments Aug–Dec 2026
...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$4.65B',
    note: '~2.5 years of preferred dividend & interest coverage · disclosed Aug 9, 2026',
    source: 'https://cryptobriefing.com/strategy-sells-another-1690-bitcoin-as-usd-reserve-hits-4-65-billion/',
  },
  SATA: {
  ...
  BMNP: {
    ...
    display: '$257M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.067M ETH staked (~87% of holdings) via MAVAN · disclosed Aug 10, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-81-million-tokens-and-total-crypto-and-total-cash-holdings-of-11-6-billion-302846858.html',
  },
};
