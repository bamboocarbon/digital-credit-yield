...
export const BMNP_DIVIDEND_SCHEDULE = [
  ...
  // 17 dividends declared via 8-K (filed ~Aug 14 2026); payment dates follow Bitmine's
  // established 10-day record-to-payment pattern; confirmed amounts from PR Newswire /
  // Investing.com / StockTitan corroboration (search result cross-reference Aug 18 2026).
...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$4.80B',
    note: '~2.8 years of preferred dividend & interest coverage · disclosed Aug 17, 2026',
    source: 'https://www.theblock.co/news/business/2026-08-17-michael-saylor-strategy-btc-411942',
  },
  SATA: {
    label: 'Cash & Equivalents',
    display: '$155M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Aug 10, 2026',
    source: 'https://cryptobriefing.com/strive-buys-147-bitcoin-20167-btc-total/',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$247M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~4.917M ETH staked (~85% of holdings) via MAVAN · disclosed Aug 2, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-8-million-tokens-and-total-crypto-and-total-cash-holdings-of-11-3-billion-302840749.html',
  },
};
