...
export const BMNP_DIVIDEND_SCHEDULE = [
  ...
  { recordDate: '2026-12-18', paymentDate: '2026-12-28', amount: 0.1847 },
];
...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    display: '$171.9M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Aug 21, 2026',
    source: 'https://www.sec.gov/Archives/edgar/data/0001920406/000162828026058518/asst-20260824.htm',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$330M/yr',
    note: 'Staking payouts fuel the dividend — annualized from 5.067M ETH staked (86.7% of holdings) via MAVAN · disclosed Aug 24, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-85-million-tokens-and-total-crypto-and-total-cash-holdings-of-14-9-billion-302857967.html',
  },
};
