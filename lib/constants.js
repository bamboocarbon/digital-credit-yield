...
export const DIVIDEND_RESERVE = {
  STRC: {
    label: 'USD Reserve',
    display: '$4.8B',
    note: '~2.5 years of preferred dividend & interest coverage · disclosed Aug 17, 2026',
  ...
  BMNP: {
    ...
    display: '$250M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.07M ETH staked (~87% of 5.82M ETH holdings) via MAVAN · disclosed Aug 16, 2026',
