...
export const BMNP_DIVIDEND_SCHEDULE = [
  ...
  // 17-dividend tranche declared Aug 14, 2026 8-K; record dates weekly Tuesdays Aug 25–Dec 18
...
export const DIVIDEND_RESERVE = {
  ...
  BMNP: {
    ...
    display: '$257M/yr',
    note: 'Staking payouts fuel the dividend — annualized from ~5.067M ETH staked (~87% of 5.81M holdings) via MAVAN · disclosed Aug 9, 2026',
    source: 'https://stockstotrade.com/news/bitmine-immersion-technologies-inc-bmnr-news-2026_08_04/',
  },
};
