...
export const STRIVE_BTC_HOLDINGS = '21,356';
...
export const DIVIDEND_RESERVE = {
  ...
  SATA: {
    ...
    display: '$183.5M',
    note: 'Part of an 18-month reserve (12mo cash + 6mo STRC holdings) · disclosed Aug 28, 2026',
    source: 'https://www.theblock.co/news/business/2026-08-31-strive-fifth-largest-public-bitcoin-treasury-1800-btc-buy-td-cowen-lifts-asst-price-target-413112',
  },
  BMNP: {
    label: 'ETH Staking Revenue',
    display: '$335M/yr',
    note: 'Staking payouts fuel the dividend — annualized from 5.067M ETH staked (85.9% of holdings) via MAVAN · disclosed Aug 30, 2026',
    source: 'https://www.prnewswire.com/news-releases/bitmine-immersion-technologies-bmnr-announces-eth-holdings-reach-5-90-million-tokens-and-total-crypto-and-total-cash-holdings-of-15-6-billion-302864579.html',
  },
};
